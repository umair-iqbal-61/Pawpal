...
const FEATURES = [
  {
    ...
    desc: 'Ask anything about your pet. Gets smarter the more you track.',
    bg: 'bg-violet-50',
  },
  {
    icon: '📊',
    title: 'Health tracking',
    desc: 'Log meals, weight, and vet visits with full history and trends.',
    bg: 'bg-teal-50',
  },
  {
    icon: '🔔',
    title: 'Smart reminders',
    desc: 'Never miss feeding time, medications, or vet appointments.',
    bg: 'bg-amber-50',
  },
  {
    icon: '🐾',
    title: 'Multi-pet support',
    desc: 'Manage all your pets from a single account.',
    bg: 'bg-pink-50',
  },
]
...
export default function Landing() {
  ...
  const handleWaitlist = async (e) => {
    ...
    if (error && error.code === '23505') {
      ...
      setSubmitted(true) // still show success, don't expose the error
      return
    }
    setSubmitted(true)
    setEmail('')
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* Nav */}
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-100 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <span className="text-2xl">🐾</span>
          <span className="text-lg font-semibold text-gray-900">PawPal</span>
        </div>
        <div className="hidden sm:flex items-center gap-6">
          <a href="#features" className="text-sm text-gray-500 hover:text-gray-800">Features</a>
          <a href="#how" className="text-sm text-gray-500 hover:text-gray-800">How it works</a>
          <a href="#pricing" className="text-sm text-gray-500 hover:text-gray-800">Pricing</a>
        </div>
        <div className="flex items-center gap-3">
          <Link to="/login" className="text-sm text-gray-500 hover:text-gray-800">Log in</Link>
          <Link to="/signup"
      ...
      <section className="px-6 pt-20 pb-16 text-center max-w-3xl mx-auto">
        <div className="inline-block bg-violet-50 text-violet-700 text-xs font-medium px-3 py-1.5 rounded-full mb-6">
          AI-powered pet care
        </div>
        ...
        <p className="text-lg text-gray-500 mb-8 max-w-xl mx-auto leading-relaxed">
          Log meals, track weight, schedule vet visits — then ask our AI anything about your pet's wellbeing. Personalized advice, not generic tips.
        </p>
        ...
        {/* App preview */}
        <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5 max-w-md mx-auto text-left shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-violet-100 flex items-center justify-center text-xl">🐶</div>
            <div>
              <p className="text-sm font-semibold text-gray-900">Bruno</p>
              <p className="text-xs text-gray-400">Golden Retriever · 3 yrs · 14kg</p>
            </div>
            <div className="ml-auto bg-green-50 text-green-700 text-xs font-medium px-2.5 py-1 rounded-full">
              Healthy
            </div>
          </div>
          <div className="bg-violet-100 text-violet-800 text-sm rounded-2xl rounded-tl-sm px-4 py-2.5 mb-2 max-w-xs">
            Is Bruno's diet balanced based on his recent meals?
          </div>
          <div className="bg-white border border-gray-100 text-gray-700 text-sm rounded-2xl rounded-tr-sm px-4 py-2.5 max-w-xs ml-auto leading-relaxed">
      ...
      {/* Social proof */}
      <div className="bg-gray-50 border-y border-gray-100 py-4 text-center">
        <p className="text-sm text-gray-400">
          Trusted by <span className="text-gray-700 font-medium">500+ pet owners</span> across 20+ countries
        </p>
      </div>
      ...
      <section id="features" className="px-6 py-20 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-xs font-semibold text-violet-600 uppercase tracking-widest mb-2">Features</p>
      ...
      {/* How it works */}
      <section id="how" className="bg-gray-50 border-y border-gray-100 px-6 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs font-semibold text-violet-600 uppercase tracking-widest mb-2">How it works</p>
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Up and running in 3 steps</h2>
      ...
      <section className="px-6 py-20 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-xs font-semibold text-violet-600 uppercase tracking-widest mb-2">Testimonials</p>
          <h2 className="text-3xl font-bold text-gray-900">Pet owners love it</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {TESTIMONIALS.map(t => (
            <div key={t.name} className="border border-gray-100 rounded-2xl p-5">
      ...
      {/* Pricing */}
      <section id="pricing" className="bg-gray-50 border-y border-gray-100 px-6 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs font-semibold text-violet-600 uppercase tracking-widest mb-2">Pricing</p>
          <h2 className="text-3xl font-bold text-gray-900 mb-12">Simple, transparent pricing</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-xl mx-auto">

            {/* Free */}
            <div className="bg-white border border-gray-200 rounded-2xl p-6 text-left">
              <p className="text-sm font-medium text-gray-400 mb-2">Free</p>
            ...
            <div className="bg-violet-600 rounded-2xl p-6 text-left relative">
              ...
              <Link to="/signup"
                className="block text-center bg-white text-violet-700 py-2.5 rounded-xl text-sm font-medium hover:bg-violet-50 transition-colors">
                Start free trial
              </Link>
            </div>
          </div>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleWaitlist} className="flex flex-col sm:flex-row gap-3 justify-center max-w-sm mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-xl text-sm text-gray-900 border border-white focus:outline-none focus:ring-2 focus:ring-white"
            />
            <button type="submit"
      ...
      <footer className="border-t border-gray-100 px-6 py-8 text-center">
        <p className="text-sm text-gray-400">© 2025 PawPal. Built with ❤️ for pet lovers.</p>
      </footer>
